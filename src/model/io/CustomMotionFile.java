...
/**
 * A representation of a a custom motion file. This class is used for the generating instruction
 * file for the model to create the animation.
 */
public class CustomMotionFile implements ICreateMotionFIle {
  ...
  private String createCustomAnimation() {
    String s = "canvas 400 500 \n"
            + "rectangle name background min-x 0 min-y 0 width 800 height 800 color 1 1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec1 min-x 100 min-y 400 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec2 min-x 150 min-y 400 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec3 min-x 200 min-y 400 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec4 min-x 250 min-y 400 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec5 min-x 300 min-y 400 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec6 min-x 350 min-y 400 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec7 min-x 125 min-y 375 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec8 min-x 175 min-y 375 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec9 min-x 225 min-y 375 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec10 min-x 275 min-y 375 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec11 min-x 325 min-y 375 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec12 min-x 150 min-y 350 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec13 min-x 200 min-y 350 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec14 min-x 250 min-y 350 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec15 min-x 300 min-y 350 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec16 min-x 175 min-y 325 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec17 min-x 225 min-y 325 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec18 min-x 275 min-y 325 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec19 min-x 200 min-y 300 width 50 height 25 color 0.1 0.1 0.9 " +
            "from 1 to 200 \n"
            + "rectangle name rec20 min-x 250 min-y 300 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "rectangle name rec21 min-x 225 min-y 275 width 50 height 25 color 0.1 0.9 0.1 " +
            "from 1 to 200 \n"
            + "oval name moon center-x 500 center-y 100 x-radius 50 y-radius 50 color 1 0.1 0.1 " +
            "from 1 to 200 \n"
